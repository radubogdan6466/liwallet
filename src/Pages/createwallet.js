...
<div className="createPage">
  <div className="createPage-nav-container">
    ...
    <button className="createPage-homeBtn" onClick={goHome}>Home</button>
  </div>
  <div className="createPage-container">
    <p className="createPage-alert">Save the phrase on an offline device or write it on paper. Once you create the wallet, you will never have access to it.</p>
